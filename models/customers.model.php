...
class ModelCustomers{
	...
	static public function mdlAddCustomer($table, $data){
		...
		$stmt = (new Connection)->connect()->prepare("INSERT INTO $table(name, idDocument, email, phone, address, birthdate) VALUES (:name, :idDocument, :email, :phone, :address, :birthdate)");
	...
	static public function mdlEditCustomer($table, $data){
		...
		$stmt = (new Connection)->connect()->prepare("UPDATE $table SET name = :name, idDocument = :idDocument, email = :email, phone = :phone, address = :address, birthdate = :birthdate WHERE id = :id");
